...
if curl -s "https://lion-trans.com/track_number?number=ZACCJBCB1HPE78193++" | grep "In Port"
then
    date >> /git/iaai-checker/check.log
else
    curl --location --request GET 'https://api.telegram.org/bot1722077150:AAFYL-X4YAxw4RgujHE6mmwsfS2CdWwLtbE/sendMessage?chat_id=-590015500&text=April-has-moved-to-ukraine' \
